...
<head>
	...
	<title>Cetak Saldo Pelanggan</title>
	<link rel="stylesheet" type="text/css" href="assets/css/bootstrap.min.css">
</head>
<body onload="print()">
	<center>
		<h2>Saldo Pelanggan</h2>
	</center>
	<?php 
	$rs = $data->row();
	 ?>
	...
	<div class="row">
		<center><h2>Histori Saldo & Belanja</h2></center>
		<div class="col-md-6">
			<table class="table">
				<tr>
					<th>Saldo Tambahan</th>
				...
				<?php 
				$sql = $this->db->query("SELECT * FROM detail_saldo where no_pelanggan='$rs->no_pelanggan'");
		...
		<div class="col-md-6">
			<table class="table">
				...
				<?php 
				$sql = $this->db->query("SELECT * FROM penjualan_header where no_pelanggan='$rs->no_pelanggan'");
				foreach ($sql->result() as $rd) {
				 ?>
				<tr>
					<td><?php echo $rd->kode_penjualan ?></td>
					<td><?php echo $rd->harga_total ?></td>
